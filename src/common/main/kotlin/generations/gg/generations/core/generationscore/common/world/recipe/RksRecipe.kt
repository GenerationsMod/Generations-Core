...
public abstract class RksRecipe(
    ...
    fun getRemainingItems(container: RksMachineBlockEntity): NonNullList<ItemStack> {
        ...
        for (i in nonNullList.indices) {
            ...
            } else if (item.hasCraftingRemainingItem()) nonNullList[i] = item.craftingRemainingItem?.let(::ItemStack) ?: ItemStack.EMPTY
        }
        return nonNullList
    }
    ...
    override fun getType(): RecipeType<*> {
        return GenerationsCoreRecipeTypes.RKS.value()
    }
}
