...
class RksRecipeProvider(arg: PackOutput, registries: CompletableFuture<HolderLookup.Provider>) : GenerationsRecipeProvider.Proxied(arg, registries) {
    override fun buildRecipes(exporter: RecipeOutput) {
        ShapedRksRecipeJsonBuilder.create(LegendKeys.MEWTWO, 70)
            ...
            .criterion("mew_fossil", InventoryChangeTrigger.TriggerInstance.hasItems(MEW_FOSSIL.value()))
        ...
        ShapedRksRecipeJsonBuilder.create(GenerationsItems.SOUL_HEART)
            ...
            .criterion("heart_scale", InventoryChangeTrigger.TriggerInstance.hasItems(GenerationsItems.HEART_SCALE.value()))
        ...
        ShapedRksRecipeJsonBuilder.create(LegendKeys.MAGEARNA, 70)
            ...
            .input('B', DamageIngredient(GenerationsItems.SOUL_HEART.value(), 100))
            .input('C', Items.IRON_INGOT)
            .key(LegendKeys.MAGEARNA)
            .criterion("soul_heart", InventoryChangeTrigger.TriggerInstance.hasItems(GenerationsItems.SOUL_HEART.value()))
        ...
        ShapedRksRecipeJsonBuilder.create(LegendKeys.GENESECT)
            ...
            .criterion("orb", InventoryChangeTrigger.TriggerInstance.hasItems(GenerationsItems.ORB.value()))
        ...
        createZCyrstal(GenerationsItems.ALORAICHIUM_Z, "raichu", "alolan", exporter)
        ...
        createZCyrstal(GenerationsItems.PIKASHUNIUM_Z, "pikachu", "rock-star", exporter)
        createZCyrstal(GenerationsItems.PIKASHUNIUM_Z, "pikachu", "belle", exporter)
        createZCyrstal(GenerationsItems.PIKASHUNIUM_Z, "pikachu", "cosplayer", exporter)
        createZCyrstal(GenerationsItems.PIKASHUNIUM_Z, "pikachu", "pop-star", exporter)
        createZCyrstal(GenerationsItems.PIKASHUNIUM_Z, "pikachu", "phd", exporter)
        createZCyrstal(GenerationsItems.PIKASHUNIUM_Z, "pikachu", "libre", exporter)
        createZCyrstal(GenerationsItems.PIKASHUNIUM_Z, "pikachu", "original", exporter)
    ...
    private fun createZCyrstal(
        ...
        ShapedRksRecipeJsonBuilder.create(result)
            ...
            .pattern("ABA")
            .pattern("XXX")
            .criterion(GenerationsItems.Z_INGOT.id.path, InventoryChangeTrigger.TriggerInstance.hasItems(GenerationsItems.Z_INGOT.value()))
    ...
    private fun createZCyrstal(result: Holder<Item>, pokemon: String, exporter: RecipeOutput) {
    ...
    private fun createZCyrstal(
        ...
        ShapedRksRecipeJsonBuilder.create(result.value())
            .input('A', Items.NETHERITE_SCRAP)
            ...
            .criterion(
                BuiltInRegistries.ITEM.getKey(GenerationsItems.Z_INGOT.value()).path,
                InventoryChangeTrigger.TriggerInstance.hasItems(GenerationsItems.Z_INGOT.value())
            )
    ...
    private fun createZCyrstal(result: Holder<Item>, item: Item, exporter: RecipeOutput) {
        ShapedRksRecipeJsonBuilder.create(result)
            .input('A', Items.NETHERITE_SCRAP)
            .input('B', item)
            .input('X', GenerationsItems.Z_INGOT)
    ...
    private fun createMegaStone(result: Holder<Item>, pokemon: String, exporter: RecipeOutput) {
        ...
        builder.pattern("ABC")
            .doesntConsumeTimeCapsules()
            .criterion(GenerationsItems.KEY_STONE.id.path, InventoryChangeTrigger.TriggerInstance.hasItems(GenerationsItems.KEY_STONE.value()))
            .save(exporter, result.id)
    }
