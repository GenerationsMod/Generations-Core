 ...
 */
object GenerationsForgeBiomemodifiers {
    fun bootstrap(context: BootstrapContext<BiomeModifier?>) {
        val placedFeaturesLookup = context.lookup(Registries.PLACED_FEATURE)
        val biomesLookup = context.lookup(Registries.BIOME)

        registerUnderGroundOres(
            context, "add_ore_silicon", HolderSet.direct(
        ...
        registerUnderGroundOres(
            context, "add_ore_sapphire", biomesLookup.getOrThrow(Tags.Biomes.IS_WET),
            HolderSet.direct(
        ...
        registerUnderGroundOres(
            context, "add_ore_sapphire_overworld", HolderSet.direct(
        ...
        registerUnderGroundOres(
            context, "add_ore_ruby", biomesLookup.getOrThrow(Tags.Biomes.IS_HOT),
            HolderSet.direct(
        ...
        registerUnderGroundOres(
            context, "add_ore_ruby_overworld", HolderSet.direct(
        ...
        registerUnderGroundOres(
            context, "add_ore_crystal", biomesLookup.getOrThrow(Tags.Biomes.IS_COLD_OVERWORLD),
            HolderSet.direct(
        ...
        registerUnderGroundOres(
            context, "add_ore_crystal_overworld", HolderSet.direct(
        ...
        registerUnderGroundOres(
            context, "add_ore_megastone_overworld", HolderSet.direct(
                placedFeaturesLookup.getOrThrow(GenerationsPlacedFeatures.ORE_MEGASTONE)
            )
        )

        registerUnderGroundOres(
            context, "add_ore_z_crystal_overworld", HolderSet.direct(
                placedFeaturesLookup.getOrThrow(GenerationsPlacedFeatures.ORE_Z_CRYSTAL)
            )
        )

        registerUnderGroundOres(
            context, "add_ore_meteorite_overworld", HolderSet.direct(
        ...
        registerSurfaceFeatures(
            context, "add_cherish_ball_loot",
            biomesLookup.getOrThrow(GenerationsBiomeTags.IS_FLORAL),
            HolderSet.direct(placedFeaturesLookup.getOrThrow(GenerationsPlacedFeatures.CHERISH_BALL_LOOT))
        )

        registerSurfaceFeatures(
            context, "add_dive_ball_loot",
        ...
        registerSurfaceFeatures(
            context, "add_level_ball_loot",
            biomesLookup.getOrThrow(GenerationsBiomeTags.IS_SAVANNA),
            HolderSet.direct(placedFeaturesLookup.getOrThrow(GenerationsPlacedFeatures.LEVEL_BALL_LOOT))
        )

        registerSurfaceFeatures(
            context, "add_love_ball_loot",
    ...
    private fun registerUnderGroundOres(
        ...
        biomeModifier: String,
        biomes: HolderSet<Biome>,
        features: HolderSet<PlacedFeature>
    ) {
        context.register(
            registerKey(biomeModifier), AddFeaturesBiomeModifier(
                biomes,
                features,
