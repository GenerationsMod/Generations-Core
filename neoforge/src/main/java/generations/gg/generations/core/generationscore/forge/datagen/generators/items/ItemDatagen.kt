...
//        createItem(GenerationsItems.PRISON_BOTTLE.get(), "legend_items/");
        ...
        createItem(GenerationsItems.TERA_BUG_SHARD.get(), "tera_shards/")
        createItem(GenerationsItems.TERA_DARK_SHARD.get(), "tera_shards/")
        createItem(GenerationsItems.TERA_DRAGON_SHARD.get(), "tera_shards/")
        createItem(GenerationsItems.TERA_ELECTRIC_SHARD.get(), "tera_shards/")
        createItem(GenerationsItems.TERA_FAIRY_SHARD.get(), "tera_shards/")
        createItem(GenerationsItems.TERA_FIGHTING_SHARD.get(), "tera_shards/")
        createItem(GenerationsItems.TERA_FIRE_SHARD.get(), "tera_shards/")
        createItem(GenerationsItems.TERA_FLYING_SHARD.get(), "tera_shards/")
        createItem(GenerationsItems.TERA_GHOST_SHARD.get(), "tera_shards/")
        createItem(GenerationsItems.TERA_GRASS_SHARD.get(), "tera_shards/")
        createItem(GenerationsItems.TERA_GROUND_SHARD.get(), "tera_shards/")
        createItem(GenerationsItems.TERA_ICE_SHARD.get(), "tera_shards/")
        createItem(GenerationsItems.TERA_NORMAL_SHARD.get(), "tera_shards/")
        createItem(GenerationsItems.TERA_POISON_SHARD.get(), "tera_shards/")
        createItem(GenerationsItems.TERA_PSYCHIC_SHARD.get(), "tera_shards/")
        createItem(GenerationsItems.TERA_ROCK_SHARD.get(), "tera_shards/")
        createItem(GenerationsItems.TERA_STEEL_SHARD.get(), "tera_shards/")
        createItem(GenerationsItems.TERA_STELLAR_SHARD.get(), "tera_shards/")
        createItem(GenerationsItems.TERA_WATER_SHARD.get(), "tera_shards/")
