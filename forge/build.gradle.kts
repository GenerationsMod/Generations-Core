...
dependencies {
    ...
    forgeRuntimeLibrary(platform("org.lwjgl:lwjgl-bom:3.3.3"))
    forgeRuntimeLibrary("org.lwjgl:lwjgl-assimp")
    forgeRuntimeLibrary("org.lwjgl:lwjgl-assimp:natives-windows")
