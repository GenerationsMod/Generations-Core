...
public class OreGenDatagen {
    ...
    public static CompletableFuture<HolderLookup.Provider> onInitialize(CompletableFuture<HolderLookup.Provider> original) {
        ...
        registerCommonOreGen(
                ...
                PLACED_FEATURE,
                BIOME_MODIFIER,
                GenerationsOres.ALUMINUM_ORE_SET.getOre(),
                List.of(OreConfiguration.target(STONE_ORE_REPLACEABLES, GenerationsOres.ALUMINUM_ORE_SET.getOre().defaultBlockState()), OreConfiguration.target(DEEPSLATE_ORE_REPLACEABLES, GenerationsOres.ALUMINUM_ORE_SET.getDeepslateOre().defaultBlockState())),
                12,
                20,
                -16,
                144,
