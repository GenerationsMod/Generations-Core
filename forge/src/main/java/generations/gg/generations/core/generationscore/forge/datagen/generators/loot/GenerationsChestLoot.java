...
public class GenerationsChestLoot implements LootTableSubProvider {
	...
	public void generate(@NotNull BiConsumer<ResourceLocation, LootTable.Builder> output) {
		...
		output.accept(GIGATON_BALL, LootTable.lootTable().withPool(createPool(ConstantValue.exactly(1.0F),
						CobblemonItems.POKE_BALL.asItem(), CobblemonItems.HEAVY_BALL.asItem(),
						CobblemonItems.HEAVY_DUTY_BOOTS.asItem(), GenerationsItems.HYPER_POTION.get(),
						...
						GenerationsItems.METAL_POWDER.get(), GenerationsItems.METRONOME.get(),
						...
						CobblemonItems.LUCKY_EGG.asItem(), GenerationsItems.POWER_ANKLET.get(),
						GenerationsItems.POWER_BAND.get(), GenerationsItems.POWER_BELT.get(),
						GenerationsItems.POWER_BRACER.get(), GenerationsItems.POWER_LENS.get(),
						GenerationsItems.POWER_WEIGHT.get(), CobblemonItems.ROCKY_HELMET.asItem(),
						GenerationsItems.ROOM_SERVICE.get(), CobblemonItems.SOFT_SAND.asItem(),
						GenerationsItems.THICK_CLUB.get(), GenerationsItems.WIDE_LENS.get(),
		...
		output.accept(GREAT_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 2),
						...
						GenerationsItems.BREAD.get(), GenerationsItems.BRIGHT_POWDER.get(),
						...
						GenerationsItems.ETHER.get(), CobblemonItems.EXPERIENCE_CANDY_S.asItem(),
						...
						CobblemonItems.HEAL_BALL.asItem(), GenerationsItems.HYPER_POTION.get(),
						...
						GenerationsItems.MAX_ETHER.get(), GenerationsItems.MENTAL_HERB.get(),
						...
						GenerationsItems.PARALYZE_HEAL.get(), CobblemonItems.PASSHO_BERRY.asItem(),
						GenerationsItems.PEARL.get(), CobblemonItems.PETAYA_BERRY.asItem(),
						GenerationsItems.POWER_LENS.get(), CobblemonItems.PRISM_SCALE.asItem(),
						...
						Items.MUSIC_DISC_STRAD, GenerationsItems.CRYSTAL.get(),
		...
		output.accept(HEAL_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 2),
						...
						GenerationsItems.ANTIDOTE.get(), CobblemonItems.ASPEAR_BERRY.asItem(),
						GenerationsItems.AWAKENING.get(), CobblemonItems.BERRY_JUICE.asItem(),
						...
						GenerationsItems.BURN_HEAL.get(), GenerationsItems.CASTELIACONE.get(),
						...
						GenerationsItems.ELIXIR.get(), GenerationsItems.ENERGY_POWDER.get(),
						CobblemonItems.ENIGMA_BERRY.asItem(), CobblemonItems.FIGY_BERRY.asItem(),
						GenerationsItems.FRESH_WATER.get(), GenerationsItems.FULL_HEAL.get(),
						GenerationsItems.FULL_RESTORE.get(), CobblemonItems.GREAT_BALL.asItem(),
						GenerationsItems.GUARD_SPEC.get(), CobblemonItems.HEAL_BALL.asItem(),
						CobblemonItems.HEAL_POWDER.asItem(), CobblemonItems.HP_UP.asItem(),
						GenerationsItems.HYPER_POTION.get(), GenerationsItems.ICE_HEAL.get(),
						...
						CobblemonItems.MAGO_BERRY.asItem(), GenerationsItems.MAX_POTION.get(),
						CobblemonItems.MAX_REVIVE.asItem(), GenerationsItems.MOOMOO_MILK.get(),
						GenerationsItems.OLD_GATEAU.get(), GenerationsItems.PARALYZE_HEAL.get(),
						...
						GenerationsItems.SUPER_POTION.get(), CobblemonItems.TAMATO_BERRY.asItem(),
						...
						Items.MILK_BUCKET, Items.MUSIC_DISC_MELLOHI,
		...
		output.accept(HEAVY_BALL, LootTable.lootTable()
				.withPool(createPool(ConstantValue.exactly(1.0F),
						...
						GenerationsItems.MAX_ETHER.get(), CobblemonItems.METAL_COAT.asItem(),
						CobblemonItems.PECHA_BERRY.asItem(), GenerationsItems.POKE_TOY.get(),
						GenerationsItems.POWER_BAND.get(), GenerationsItems.PROTECTIVE_PADS.get(),
						...
						Items.QUARTZ, Items.MUSIC_DISC_MELLOHI,
		...
		output.accept(JET_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 2),
						...
						GenerationsItems.LIGHT_BALL.get(), GenerationsItems.POWER_HERB.get(),
						GenerationsItems.MENTAL_HERB.get(), CobblemonItems.MIRROR_HERB.asItem(),
						GenerationsItems.WHITE_HERB.get(), CobblemonItems.SILK_SCARF.asItem(),
						GenerationsItems.MAX_POTION.get(), GenerationsItems.MAX_REPEL.get(),
						GenerationsItems.METAL_POWDER.get(), GenerationsItems.METRONOME.get(),
						CobblemonItems.NANAB_BERRY.asItem(), CobblemonItems.POMEG_BERRY.asItem(),
						GenerationsItems.POWER_ANKLET.get(), GenerationsItems.POWER_BAND.get(),
						...
						GenerationsItems.TERRAIN_EXTENDER.get(), GenerationsItems.AWAKENING.get(),
						...
						GenerationsItems.LEMONADE.get(), GenerationsItems.PARALYZE_HEAL.get(),
						...
						GenerationsItems.HONEY.get(), GenerationsItems.LEEK.get(),
						...
						GenerationsItems.X_SPEED_6.get(), GenerationsItems.X_ACCURACY.get(),
		...
		output.accept(LEVEL_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 2),
						...
						CobblemonItems.CARBOS.asItem(), CobblemonItems.ELECTIRIZER.asItem(), GenerationsItems.ETHER.get(),
						GenerationsItems.EVERSTONE.get(), CobblemonItems.EXPERIENCE_CANDY_XL.asItem(), CobblemonItems.EXP_SHARE.asItem(),
						...
						GenerationsItems.PEARL_STRING.get(), GenerationsItems.POWER_BRACER.get(), CobblemonItems.PRISM_SCALE.asItem(),
						CobblemonItems.PROTECTOR.asItem(), GenerationsItems.QUICK_POWDER.get(), CobblemonItems.RARE_CANDY.asItem(),
		...
		output.accept(LOVE_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 2),
						...
						GenerationsItems.BINDING_BAND.get(), GenerationsItems.BURN_HEAL.get(), CobblemonItems.CHERI_BERRY.asItem(),
						CobblemonItems.CHERISH_BALL.asItem(), CobblemonItems.CLOVER_SWEET.asItem(), GenerationsItems.COURAGE_CANDY_XL.get(),
						GenerationsItems.DESTINY_KNOT.get(), CobblemonItems.DRAGON_SCALE.asItem(), CobblemonItems.DUBIOUS_DISC.asItem(),
						GenerationsItems.EVERSTONE.get(), CobblemonItems.EXPERIENCE_CANDY_XS.asItem(), GenerationsItems.FANCY_APPLE.get(),
						GenerationsItems.FRESH_WATER.get(), GenerationsItems.GUARD_SPEC.get(), CobblemonItems.HABAN_BERRY.asItem(),
						GenerationsItems.HEALTH_CANDY_L.get(), GenerationsItems.HONEY.get(), CobblemonItems.HP_UP.asItem(),
						GenerationsItems.ICE_HEAL.get(), CobblemonItems.ICE_STONE.asItem(), CobblemonItems.LEPPA_BERRY.asItem(),
						CobblemonItems.LOVE_BALL.asItem(), CobblemonItems.LOVE_SWEET.asItem(), GenerationsItems.MAX_POTION.get(),
						CobblemonItems.OVAL_STONE.asItem(), GenerationsItems.PEARL_STRING.get(), GenerationsItems.PINK_SCARF.get(),
						GenerationsItems.POKE_DOLL.get(), GenerationsItems.POTION.get(), GenerationsItems.POWER_ANKLET.get(),
						GenerationsItems.POWER_BRACER.get(), GenerationsItems.MIRROR.get(), GenerationsItems.CERULEAN_CITY_DISC.get(),
						...
						GenerationsItems.WHITE_FLUTE.get(), GenerationsItems.WHITE_HERB.get(), GenerationsItems.X_DEFENSE_3.get(),
		...
		output.accept(LURE_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 2),
						...
						GenerationsItems.BOBS_FOOD_TIN.get(), GenerationsItems.CHARCOAL.get(), CobblemonItems.CHARTI_BERRY.asItem(),
						...
						GenerationsItems.HONEY.get(), GenerationsItems.ICE_HEAL.get(), CobblemonItems.JABOCA_BERRY.asItem(),
						...
						GenerationsItems.MAX_LURE.get(), GenerationsItems.MAX_REPEL.get(), GenerationsItems.METAL_POWDER.get(),
						...
						GenerationsItems.POKE_TOY.get(), GenerationsItems.POWER_HERB.get(), GenerationsItems.POWER_PLANT_PASS.get(),
						...
						Items.PRISMARINE, Items.FEATHER, Items.BONE, Items.GHAST_TEAR,
		...
		output.accept(LUXURY_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 2),
						...
						GenerationsItems.FESTIVAL_TICKET.get(), CobblemonItems.FLOWER_SWEET.asItem(), GenerationsItems.FULL_HEAL.get(),
						GenerationsItems.FIERY_WING.get(), CobblemonItems.GREAT_BALL.asItem(), GenerationsItems.GREEN_SCARF.get(),
						CobblemonItems.GREPA_BERRY.asItem(), GenerationsItems.HEALTH_CANDY_L.get(), GenerationsItems.ICE_HEAL.get(),
						...
						GenerationsItems.PEWTER_CRUNCHIES.get(), GenerationsItems.POWER_BAND.get(), CobblemonItems.PREMIER_BALL.asItem(),
						...
						Items.DIAMOND, Items.LEATHER, GenerationsItems.ELEGANT_WING.get(), Items.MUSIC_DISC_CHIRP,
		...
		output.accept(MASTER_BALL, LootTable.lootTable()
				.withPool(createPool(ConstantValue.exactly(1),
						...
						GenerationsItems.BURN_HEAL.get(), CobblemonItems.CHERI_BERRY.asItem(), CobblemonItems.CHESTO_BERRY.asItem(),
						...
						CobblemonItems.EXPERIENCE_CANDY_XL.asItem(), GenerationsItems.FULL_RESTORE.get(), GenerationsItems.GIGANTAMIX.get(),
						...
						GenerationsItems.TM_147.get(), GenerationsItems.TM_166.get()
				)));
		...
		output.accept(MOON_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 2),
						...
						CobblemonItems.DAWN_STONE.asItem(), CobblemonItems.DUSK_STONE.asItem(), GenerationsItems.EVERSTONE.get(),
						...
						CobblemonItems.HEAVY_BALL.asItem(), GenerationsItems.HI_TECH_EARBUDS.get(), GenerationsItems.HYPER_POTION.get(),
						...
						CobblemonItems.MAGNET.asItem(), GenerationsItems.MAX_ETHER.get(), CobblemonItems.METAL_COAT.asItem(),
						GenerationsItems.METAL_POWDER.get(), GenerationsItems.METRONOME.get(), GenerationsItems.MISTY_SEED.get(),
						CobblemonItems.MOON_BALL.asItem(), CobblemonItems.MOON_STONE.asItem(), CobblemonItems.NEVER_MELT_ICE.asItem(),
						CobblemonItems.PAYAPA_BERRY.asItem(), GenerationsItems.POISON_GEM.get(), GenerationsItems.POWER_WEIGHT.get(),
						...
						GenerationsItems.WISHING_PIECE.get(), GenerationsItems.X_SPEED.get(), Items.PURPUR_BLOCK,
		...
		output.accept(NEST_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 2),
						...
						CobblemonItems.LIECHI_BERRY.asItem(), CobblemonItems.LUM_BERRY.asItem(), GenerationsItems.MENTAL_HERB.get(),
						...
						GenerationsItems.POKE_TOY.get(), GenerationsItems.POWER_HERB.get(), GenerationsItems.PRETTY_FEATHER.get(),
						...
						GenerationsItems.WHITE_HERB.get(), CobblemonItems.WIKI_BERRY.asItem(), GenerationsItems.X_ACCURACY.get(),
						GenerationsItems.X_ATTACK_2.get(), GenerationsItems.X_DEFENSE.get(), GenerationsItems.X_SPECIAL_ATTACK.get(),
						GenerationsItems.X_SPECIAL_DEFENSE.get(), Items.COBWEB, Items.FEATHER, Items.MUSIC_DISC_11,
		...
		output.accept(NET_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 3),
						...
						GenerationsItems.COURAGE_CANDY_XL.get(), GenerationsItems.DIRE_HIT.get(), CobblemonItems.DURIN_BERRY.asItem(),
						GenerationsItems.ELIXIR.get(), CobblemonItems.ENERGY_ROOT.asItem(), CobblemonItems.FRIEND_BALL.asItem(),
						...
						CobblemonItems.MARANGA_BERRY.asItem(), GenerationsItems.MAX_ELIXIR.get(), CobblemonItems.MICLE_BERRY.asItem(),
						...
						GenerationsItems.X_ATTACK_3.get(), GenerationsItems.X_DEFENSE.get(), GenerationsItems.X_SPECIAL_ATTACK.get(),
						GenerationsItems.X_SPECIAL_DEFENSE.get(), GenerationsItems.X_SPEED.get(), CobblemonItems.YACHE_BERRY.asItem(),
		...
		output.accept(ORIGIN_BALL, LootTable.lootTable()
				.withPool(createPool(ConstantValue.exactly(1),
						...
						GenerationsItems.EXP_CHARM.get(), GenerationsItems.ANTIDOTE.get(), CobblemonItems.APICOT_BERRY.asItem(),
						CobblemonItems.ASPEAR_BERRY.asItem(), CobblemonItems.BABIRI_BERRY.asItem(), CobblemonItems.BERRY_JUICE.asItem(),
						GenerationsItems.BURN_HEAL.get(), CobblemonItems.GROWTH_MULCH.asItem(), CobblemonItems.RICH_MULCH.asItem(),
						...
						GenerationsItems.TM_115.get(), GenerationsItems.TM_156.get(), GenerationsItems.TM_169.get()
				)));
		...
		output.accept(PARK_BALL, LootTable.lootTable()
				.withPool(createPool(ConstantValue.exactly(1),
						...
						CobblemonItems.CHOICE_BAND.asItem(), GenerationsItems.COMET_SHARD.get(), GenerationsItems.DESTINY_KNOT.get(),
						...
						GenerationsItems.X_ACCURACY_3.get(), GenerationsItems.X_DEFENSE.get(), GenerationsItems.X_SPECIAL_ATTACK_6.get(),
		...
		output.accept(POKE_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 3),
						...
						GenerationsItems.ANTIDOTE.get(), CobblemonItems.APICOT_BERRY.asItem(), CobblemonItems.ASPEAR_BERRY.asItem(),
						CobblemonItems.BABIRI_BERRY.asItem(), GenerationsItems.BACHS_FOOD_TIN.get(), GenerationsItems.BOBS_FOOD_TIN.get(),
						GenerationsItems.BOILED_EGG.get(), GenerationsItems.BREAD.get(), GenerationsItems.BURN_HEAL.get(),
						GenerationsItems.CELL_BATTERY.get(), CobblemonItems.CHARTI_BERRY.asItem(), CobblemonItems.CHESTO_BERRY.asItem(),
						CobblemonItems.CUSTAP_BERRY.asItem(), GenerationsItems.DIRE_HIT.get(), GenerationsItems.ELIXIR.get(),
						...
						GenerationsItems.GUARD_SPEC.get(), CobblemonItems.HEAL_POWDER.asItem(), GenerationsItems.HEALTH_CANDY.get(),
						...
						GenerationsItems.METAL_POWDER.get(), CobblemonItems.MICLE_BERRY.asItem(), GenerationsItems.MOOMOO_CHEESE.get(),
						...
						GenerationsItems.TINY_MUSHROOM.get(), GenerationsItems.TOUGH_CANDY.get(), GenerationsItems.X_ATTACK.get(),
						...
						GenerationsItems.POKEMAIL_WAVE.get(), GenerationsItems.POKEMAIL_WOOD.get()
				)));
		...
		output.accept(PREMIER_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 2),
						...
						GenerationsItems.DESTINY_KNOT.get(), GenerationsItems.DIRE_HIT_3.get(), GenerationsItems.DISCOUNT_COUPON.get(),
						...
						GenerationsItems.GUARD_SPEC.get(), GenerationsItems.HEALTH_CANDY_XL.get(), GenerationsItems.HEART_SCALE.get(),
						...
						CobblemonItems.ULTRA_BALL.asItem(), GenerationsItems.UTILITY_UMBRELLA.get(), GenerationsItems.WHITE_HERB.get(),
		...
		output.accept(QUICK_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 2),
						CobblemonItems.POKE_BALL.asItem(), GenerationsItems.ANTIDOTE.get(), CobblemonItems.BERRY_JUICE.asItem(),
						...
						GenerationsItems.MAX_POTION.get(), GenerationsItems.MAX_REPEL.get(), GenerationsItems.METAL_POWDER.get(),
						GenerationsItems.METRONOME.get(), CobblemonItems.NANAB_BERRY.asItem(), CobblemonItems.POMEG_BERRY.asItem(),
						GenerationsItems.POWER_ANKLET.get(), GenerationsItems.POWER_BAND.get(), GenerationsItems.PRECOOKED_BURGER.get(),
		...
		output.accept(REPEAT_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 3),
						...
						GenerationsItems.GUARD_SPEC.get(), CobblemonItems.HEAVY_BALL.asItem(), GenerationsItems.HYPER_POTION.get(),
						...
						GenerationsItems.X_DEFENSE_2.get(), GenerationsItems.X_SPECIAL_ATTACK.get(), GenerationsItems.X_SPECIAL_DEFENSE_3.get(),
						GenerationsItems.X_SPEED.get(), GenerationsItems.YELLOW_SHARD.get(), CobblemonItems.ZINC.asItem(),
		...
		output.accept(SAFARI_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 2),
						...
						GenerationsItems.ETHER.get(), CobblemonItems.EXPERIENCE_CANDY_S.asItem(), CobblemonItems.EXP_SHARE.asItem(),
						...
						GenerationsItems.MENTAL_HERB.get(), GenerationsItems.MIGHTY_CANDY.get(), CobblemonItems.MIRACLE_SEED.asItem(),
		...
		output.accept(SPORT_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 2),
						...
						GenerationsItems.BLUE_FLUTE.get(), GenerationsItems.BREAD.get(), GenerationsItems.BRIGHT_POWDER.get(),
						GenerationsItems.CHARCOAL.get(), CobblemonItems.CHILAN_BERRY.asItem(), CobblemonItems.CHOPLE_BERRY.asItem(),
						...
						GenerationsItems.POWER_ANKLET.get(), GenerationsItems.POWER_BRACER.get(), GenerationsItems.ELEGANT_WING.get(),
						...
						CobblemonItems.SPORT_BALL.asItem(), GenerationsItems.STICKY_BARB.get(), GenerationsItems.SUPER_POTION.get(),
						...
						GenerationsItems.X_SPECIAL_DEFENSE.get(), Items.STRING, Items.GUNPOWDER, Items.SADDLE,
		...
		output.accept(STRANGE_BALL, LootTable.lootTable()
				.withPool(createPool(ConstantValue.exactly(1),
						...
						GenerationsItems.PLASMA_CARD.get(), CobblemonItems.POKE_BALL.asItem(), GenerationsItems.POWER_WEIGHT.get(),
		...
		output.accept(TIMER_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 3),
						...
						GenerationsItems.BRIGHT_POWDER.get(), CobblemonItems.COBA_BERRY.asItem(), GenerationsItems.COCONUT_MILK.get(),
						...
						GenerationsItems.FRESH_CREAM.get(), GenerationsItems.FULL_RESTORE.get(), GenerationsItems.GRIP_CLAW.get(),
						...
						GenerationsItems.PLASMA_CARD.get(), CobblemonItems.POMEG_BERRY.asItem(), GenerationsItems.POWER_HERB.get(),
