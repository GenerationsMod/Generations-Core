	...
	public void generate(@NotNull BiConsumer<ResourceLocation, LootTable.Builder> output) {
		...
		output.accept(FRIEND_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 2),
						...
						GenerationsItems.BIG_MALASADA.get(), GenerationsItems.BOBS_FOOD_TIN.get(), GenerationsItems.BRIGHT_POWDER.get(),
						...
						CobblemonItems.LUXURY_BALL.asItem(), GenerationsItems.MAX_ELIXIR.get(), GenerationsItems.MOOMOO_CHEESE.get(),
						...
						CobblemonItems.POMEG_BERRY.asItem(), GenerationsItems.POWER_WEIGHT.get(), GenerationsItems.PRECOOKED_BURGER.get(),
						GenerationsItems.PROTECTIVE_PADS.get(), CobblemonItems.QUALOT_BERRY.asItem(), GenerationsItems.QUICK_CANDY_L.get(),
						GenerationsItems.QUICK_POWDER.get(), CobblemonItems.RAWST_BERRY.asItem(), CobblemonItems.RAZOR_CLAW.asItem(),
						...
						CobblemonItems.WHIPPED_DREAM.asItem(), GenerationsItems.X_ATTACK.get(), GenerationsItems.SHATTERED_RELIC_SONG_1.get(),
						...
						GenerationsItems.TM_116.get(), GenerationsItems.TM_105.get())));
	}
