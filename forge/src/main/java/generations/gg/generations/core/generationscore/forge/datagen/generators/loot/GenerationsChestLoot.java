...
public class GenerationsChestLoot implements LootTableSubProvider {
	...
	public void generate(@NotNull BiConsumer<ResourceLocation, LootTable.Builder> output) {
		...
		output.accept(DIVE_BALL, LootTable.lootTable().withPool(createPool(UniformGenerator.between(1.0F, 2.0F),
				...
				GenerationsItems.POKE_DOLL.get(), CobblemonItems.POTION.asItem(), GenerationsItems.POWER_BELT.get(),
		...
		output.accept(LOVE_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 2),
						...
						GenerationsItems.POKE_DOLL.get(), CobblemonItems.POTION.asItem(), GenerationsItems.POWER_ANKLET.get(),
		...
		output.accept(QUICK_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 2),
						...
						CobblemonItems.MAX_POTION.asItem(), GenerationsItems.MAX_REPEL.get(), GenerationsItems.METAL_POWDER.get(),
		...
		output.accept(REPEAT_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 3),
						...
						GenerationsItems.GUARD_SPEC.get(), CobblemonItems.HEAVY_BALL.asItem(), CobblemonItems.HYPER_POTION.asItem(),
		...
		output.accept(ULTRA_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 3),
						...
						CobblemonItems.FULL_HEAL.asItem(), GenerationsItems.FULL_RESTORE.get(), GenerationsItems.FIERY_WING.get(),
		...
		output.accept(WING_BALL, LootTable.lootTable()
				.withPool(createPool(UniformGenerator.between(1, 2),
						...
						GenerationsItems.ANTIDOTE.get(), GenerationsItems.MAX_ELIXIR.get(), CobblemonItems.HYPER_POTION.asItem(),
