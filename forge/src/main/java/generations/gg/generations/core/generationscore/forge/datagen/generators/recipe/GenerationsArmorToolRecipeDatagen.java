...
public class GenerationsArmorToolRecipeDatagen extends GenerationsRecipeProvider.Proxied implements IConditionBuilder {
	...
	protected void buildRecipes(@NotNull Consumer<FinishedRecipe> consumer) {
		...
		buildArmorToolFullSetCrafting(consumer, CobblemonItems.DAWN_STONE.asItem(), GenerationsArmor.DAWN_STONE_HELMET.get(), GenerationsArmor.DAWN_STONE_CHESTPLATE.get(), GenerationsArmor.DAWN_STONE_LEGGINGS.get(), GenerationsArmor.DAWN_STONE_BOOTS.get(), GenerationsTools.DAWN_STONE);
		buildArmorToolFullSetCrafting(consumer, CobblemonItems.DUSK_STONE.asItem(), GenerationsArmor.DUSK_STONE_HELMET.get(), GenerationsArmor.DUSK_STONE_CHESTPLATE.get(), GenerationsArmor.DUSK_STONE_LEGGINGS.get(), GenerationsArmor.DUSK_STONE_BOOTS.get(), GenerationsTools.DUSK_STONE);
		buildArmorToolFullSetCrafting(consumer, CobblemonItems.FIRE_STONE.asItem(), GenerationsArmor.FIRE_STONE_HELMET.get(), GenerationsArmor.FIRE_STONE_CHESTPLATE.get(), GenerationsArmor.FIRE_STONE_LEGGINGS.get(), GenerationsArmor.FIRE_STONE_BOOTS.get(), GenerationsTools.FIRE_STONE);
		buildArmorToolFullSetCrafting(consumer, CobblemonItems.ICE_STONE.asItem(), GenerationsArmor.ICE_STONE_HELMET.get(), GenerationsArmor.ICE_STONE_CHESTPLATE.get(), GenerationsArmor.ICE_STONE_LEGGINGS.get(), GenerationsArmor.ICE_STONE_BOOTS.get(), GenerationsTools.ICE_STONE);
		buildArmorToolFullSetCrafting(consumer, CobblemonItems.LEAF_STONE.asItem(), GenerationsArmor.LEAF_STONE_HELMET.get(), GenerationsArmor.LEAF_STONE_CHESTPLATE.get(), GenerationsArmor.LEAF_STONE_LEGGINGS.get(), GenerationsArmor.LEAF_STONE_BOOTS.get(), GenerationsTools.LEAF_STONE);
		buildArmorToolFullSetCrafting(consumer, CobblemonItems.SUN_STONE.asItem(), GenerationsArmor.SUN_STONE_HELMET.get(), GenerationsArmor.SUN_STONE_CHESTPLATE.get(), GenerationsArmor.SUN_STONE_LEGGINGS.get(), GenerationsArmor.SUN_STONE_BOOTS.get(), GenerationsTools.SUN_STONE);
		buildArmorToolFullSetCrafting(consumer, CobblemonItems.MOON_STONE.asItem(), GenerationsArmor.MOON_STONE_HELMET.get(), GenerationsArmor.MOON_STONE_CHESTPLATE.get(), GenerationsArmor.MOON_STONE_LEGGINGS.get(), GenerationsArmor.MOON_STONE_BOOTS.get(), GenerationsTools.MOON_STONE);
		buildArmorToolFullSetCrafting(consumer, CobblemonItems.THUNDER_STONE.asItem(), GenerationsArmor.THUNDER_STONE_HELMET.get(), GenerationsArmor.THUNDER_STONE_CHESTPLATE.get(), GenerationsArmor.THUNDER_STONE_LEGGINGS.get(), GenerationsArmor.THUNDER_STONE_BOOTS.get(), GenerationsTools.THUNDER_STONE);
		buildArmorToolFullSetCrafting(consumer, CobblemonItems.WATER_STONE.asItem(), GenerationsArmor.WATER_STONE_HELMET.get(), GenerationsArmor.WATER_STONE_CHESTPLATE.get(), GenerationsArmor.WATER_STONE_LEGGINGS.get(), GenerationsArmor.WATER_STONE_BOOTS.get(), GenerationsTools.WATER_STONE);
		...
		buildModifiedArmorSetCrafting(consumer, GenerationsItems.RUBY.get(), CobblemonItems.FIRE_STONE.asItem(), GenerationsArmor.FLARE_HELMET.get(), GenerationsArmor.FLARE_CHESTPLATE.get(), GenerationsArmor.FLARE_LEGGINGS.get(), GenerationsArmor.FLARE_BOOTS.get());
