...
public class GenerationsArmorToolRecipeDatagen extends GenerationsRecipeProvider.Proxied implements IConditionBuilder {
	...
	protected void buildRecipes(@NotNull Consumer<FinishedRecipe> consumer) {
		...
		buildModifiedArmorSetCrafting(consumer, GenerationsItems.RUBY.get(), GenerationsItems.RUBY.get(), GenerationsArmor.FLARE_HELMET.get(), GenerationsArmor.FLARE_CHESTPLATE.get(), GenerationsArmor.FLARE_LEGGINGS.get(), GenerationsArmor.FLARE_BOOTS.get());
