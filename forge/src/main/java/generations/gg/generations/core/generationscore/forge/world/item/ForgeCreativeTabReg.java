...
public class ForgeCreativeTabReg {
    ...
    public static void init(IEventBus MOD_BUS) {
        ...
        AWARDS = create("awards", () -> GenerationsItems.RAINBOW_BADGE.get().getDefaultInstance(), GenerationsItems.BADGES, GenerationsItems.RIBBONS);
        ...
        UTILITY = create("utility", () -> GenerationsUtilityBlocks.RKS_MACHINE.get().asItem().getDefaultInstance(), GenerationsUtilityBlocks.UTILITY_BLOCKS);
