...
public class GenerationsItems {
    ...
    public static final RegistrySupplier<Item> FAIRY_BADGE_2 = createBadge("fairy_2");
    ...
    public static final RegistrySupplier<Item> GALAR_CHAMPION_RIBBON = createRibbon("galar_champion_ribbon");
    ...
    public static final RegistrySupplier<Item> TWINKLING_STAR_RIBBON = createRibbon("twinkling_star_ribbon");
    public static final RegistrySupplier<Item> CONTEST_MEMORY_RIBBON = createRibbon("contest_memory_ribbon");
    ...
    public static final RegistrySupplier<Item> BATTLE_MEMORY_RIBBON = createRibbon("battle_memory_ribbon");
    ...
    public static final RegistrySupplier<Item> BATTLE_ROYAL_RIBBON = createRibbon("battle_royal_ribbon");
    public static final RegistrySupplier<Item> MASTER_RANK_RIBBON = createRibbon("master_rank_ribbon");
    public static final RegistrySupplier<Item> HISUI_RIBBON = createRibbon("hisui_ribbon");
    public static final RegistrySupplier<Item> ONCE_IN_A_LIFETIME_RIBBON = createRibbon("once_in_a_lifetime_ribbon");
    public static final RegistrySupplier<Item> PARTNER_RIBBON = createRibbon("partner_ribbon");
    ...
    public static final RegistrySupplier<Item> SILVER_KNOWLEDGE_SYMBOL = createRibbon("silver_knowledge_symbol");
    public static final RegistrySupplier<Item> GOLD_KNOWLEDGE_SYMBOL = createRibbon("gold_knowledge_symbol");
    public static final RegistrySupplier<Item> SILVER_GUTS_SYMBOL = createRibbon("silver_guts_symbol");
    public static final RegistrySupplier<Item> GOLD_GUTS_SYMBOL = createRibbon("gold_guts_symbol");
    public static final RegistrySupplier<Item> SILVER_TACTICS_SYMBOL = createRibbon("silver_tactics_symbol");
    public static final RegistrySupplier<Item> GOLD_TACTICS_SYMBOL = createRibbon("gold_tactics_symbol");
    public static final RegistrySupplier<Item> SILVER_LUCK_SYMBOL = createRibbon("silver_luck_symbol");
    public static final RegistrySupplier<Item> GOLD_LUCK_SYMBOL = createRibbon("gold_luck_symbol");
    public static final RegistrySupplier<Item> SILVER_SPIRITS_SYMBOL = createRibbon("silver_spirits_symbol");
    public static final RegistrySupplier<Item> GOLD_SPIRITS_SYMBOL = createRibbon("gold_spirits_symbol");
    public static final RegistrySupplier<Item> SILVER_BRAVE_SYMBOL = createRibbon("silver_brave_symbol");
    public static final RegistrySupplier<Item> GOLD_BRAVE_SYMBOL = createRibbon("gold_brave_symbol");
    public static final RegistrySupplier<Item> SILVER_ABILITY_SYMBOL = createRibbon("silver_ability_symbol");
    public static final RegistrySupplier<Item> GOLD_ABILITY_SYMBOL = createRibbon("gold_ability_symbol");
