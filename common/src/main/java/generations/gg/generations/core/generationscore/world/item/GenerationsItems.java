...
public class GenerationsItems {
    ...
    public static final RegistrySupplier<Item> TM_5 = register("tm_5", properties -> new TechnicalMachineItem("mud_slap", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_6 = register("tm_6", properties -> new TechnicalMachineItem("scary_face", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_7 = register("tm_7", properties -> new TechnicalMachineItem("protect", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_8 = register("tm_8", properties -> new TechnicalMachineItem("fire_fang", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_9 = register("tm_9", properties -> new TechnicalMachineItem("thunder_fang", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_10 = register("tm_10", properties -> new TechnicalMachineItem("ice_fang", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_11 = register("tm_11", properties -> new TechnicalMachineItem("water_pulse", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_12 = register("tm_12", properties -> new TechnicalMachineItem("low_kick", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_13 = register("tm_13", properties -> new TechnicalMachineItem("acid_spray", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_14 = register("tm_14", properties -> new TechnicalMachineItem("acrobatics", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_15 = register("tm_15", properties -> new TechnicalMachineItem("struggle_bug", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_16 = register("tm_16", properties -> new TechnicalMachineItem("psybeam", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_17 = register("tm_17", properties -> new TechnicalMachineItem("confuse_ray", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_18 = register("tm_18", properties -> new TechnicalMachineItem("thief", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_19 = register("tm_19", properties -> new TechnicalMachineItem("disarming_voice", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_20 = register("tm_20", properties -> new TechnicalMachineItem("trailblaze", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_21 = register("tm_21", properties -> new TechnicalMachineItem("pounce", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_22 = register("tm_22", properties -> new TechnicalMachineItem("chilling_water", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_23 = register("tm_23", properties -> new TechnicalMachineItem("charge_beam", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_24 = register("tm_24", properties -> new TechnicalMachineItem("fire_spin", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_25 = register("tm_25", properties -> new TechnicalMachineItem("facade", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_26 = register("tm_26", properties -> new TechnicalMachineItem("poison_tail", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_27 = register("tm_27", properties -> new TechnicalMachineItem("aerial_ace", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_28 = register("tm_28", properties -> new TechnicalMachineItem("bulldoze", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_29 = register("tm_29", properties -> new TechnicalMachineItem("hex", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_30 = register("tm_30", properties -> new TechnicalMachineItem("snarl", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_31 = register("tm_31", properties -> new TechnicalMachineItem("metal_claw", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_32 = register("tm_32", properties -> new TechnicalMachineItem("switft", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_33 = register("tm_33", properties -> new TechnicalMachineItem("magical_leaf", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_34 = register("tm_34", properties -> new TechnicalMachineItem("icy_wind", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_35 = register("tm_35", properties -> new TechnicalMachineItem("mud_shot", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_36 = register("tm_36", properties -> new TechnicalMachineItem("rock_tomb", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_37 = register("tm_37", properties -> new TechnicalMachineItem("draining_kiss", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_38 = register("tm_38", properties -> new TechnicalMachineItem("flame_charge", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_39 = register("tm_39", properties -> new TechnicalMachineItem("low_sweep", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_40 = register("tm_40", properties -> new TechnicalMachineItem("air_cutter", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_41 = register("tm_41", properties -> new TechnicalMachineItem("stored_power", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_42 = register("tm_42", properties -> new TechnicalMachineItem("night_shade", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_43 = register("tm_43", properties -> new TechnicalMachineItem("fling", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_44 = register("tm_44", properties -> new TechnicalMachineItem("dragon_tail", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_45 = register("tm_45", properties -> new TechnicalMachineItem("venoshock", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_46 = register("tm_46", properties -> new TechnicalMachineItem("avalanche", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_47 = register("tm_47", properties -> new TechnicalMachineItem("endure", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_48 = register("tm_48", properties -> new TechnicalMachineItem("volt_switch", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_49 = register("tm_49", properties -> new TechnicalMachineItem("sunny_day", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_50 = register("tm_50", properties -> new TechnicalMachineItem("rain_dance", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_51 = register("tm_51", properties -> new TechnicalMachineItem("sandstorm", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_52 = register("tm_52", properties -> new TechnicalMachineItem("snowscape", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_53 = register("tm_53", properties -> new TechnicalMachineItem("smart_strike", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_54 = register("tm_54", properties -> new TechnicalMachineItem("psyshock", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_55 = register("tm_55", properties -> new TechnicalMachineItem("dig", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_56 = register("tm_56", properties -> new TechnicalMachineItem("bullet_seed", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_57 = register("tm_57", properties -> new TechnicalMachineItem("false_swipe", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_58 = register("tm_58", properties -> new TechnicalMachineItem("brick_break", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_59 = register("tm_59", properties -> new TechnicalMachineItem("zen_headbutt", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_60 = register("tm_60", properties -> new TechnicalMachineItem("u_turn", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_61 = register("tm_61", properties -> new TechnicalMachineItem("shadow_claw", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_62 = register("tm_62", properties -> new TechnicalMachineItem("foul_play", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_63 = register("tm_63", properties -> new TechnicalMachineItem("psychic_fangs", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_64 = register("tm_64", properties -> new TechnicalMachineItem("bulk_up", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_65 = register("tm_65", properties -> new TechnicalMachineItem("air_slash", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_66 = register("tm_66", properties -> new TechnicalMachineItem("body_slam", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_67 = register("tm_67", properties -> new TechnicalMachineItem("fire_punch", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_68 = register("tm_68", properties -> new TechnicalMachineItem("thunder_punch", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_69 = register("tm_69", properties -> new TechnicalMachineItem("ice_punch", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_70 = register("tm_70", properties -> new TechnicalMachineItem("sleep_talk", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_71 = register("tm_71", properties -> new TechnicalMachineItem("seed_bomb", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_72 = register("tm_72", properties -> new TechnicalMachineItem("electro_ball", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_73 = register("tm_73", properties -> new TechnicalMachineItem("drain_punch", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_74 = register("tm_74", properties -> new TechnicalMachineItem("reflect", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_75 = register("tm_75", properties -> new TechnicalMachineItem("light_screen", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_76 = register("tm_76", properties -> new TechnicalMachineItem("rock_blast", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_77 = register("tm_77", properties -> new TechnicalMachineItem("waterfall", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_78 = register("tm_78", properties -> new TechnicalMachineItem("dragon_claw", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_79 = register("tm_79", properties -> new TechnicalMachineItem("dazzling_gleam", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_80 = register("tm_80", properties -> new TechnicalMachineItem("metronome", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_81 = register("tm_81", properties -> new TechnicalMachineItem("grass_knot", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_82 = register("tm_82", properties -> new TechnicalMachineItem("thunder_wave", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_83 = register("tm_83", properties -> new TechnicalMachineItem("poison_jab", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_84 = register("tm_84", properties -> new TechnicalMachineItem("stomping_tantrum", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_85 = register("tm_85", properties -> new TechnicalMachineItem("rest", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_86 = register("tm_86", properties -> new TechnicalMachineItem("rock_slide", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_87 = register("tm_87", properties -> new TechnicalMachineItem("taunt", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_88 = register("tm_88", properties -> new TechnicalMachineItem("swords_dance", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_89 = register("tm_89", properties -> new TechnicalMachineItem("body_press", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_90 = register("tm_90", properties -> new TechnicalMachineItem("spikes", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_91 = register("tm_91", properties -> new TechnicalMachineItem("toxic_spikes", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_92 = register("tm_92", properties -> new TechnicalMachineItem("imprison", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_93 = register("tm_93", properties -> new TechnicalMachineItem("flash_cannon", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_94 = register("tm_94", properties -> new TechnicalMachineItem("dark_pulse", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_95 = register("tm_95", properties -> new TechnicalMachineItem("leech_life", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_96 = register("tm_96", properties -> new TechnicalMachineItem("eerie_impulse", properties), GenerationsCreativeTabs.TMS);
    public static final RegistrySupplier<Item> TM_97 = register("tm_97", properties -> new TechnicalMachineItem("fly", properties), GenerationsCreativeTabs.TMS);
...
//        }
    ...
    public static final RegistrySupplier<Item> QUALOT_BERRY = register("qualot_berry", properties -> new BerryItem(BerryType.QUALOT, GenerationsBlocks.QUALOT_BERRY_BUSH, properties), GenerationsCreativeTabs.HELD_ITEMS);
    ...
    public static final RegistrySupplier<Item> SPELON_BERRY = register("spelon_berry", properties -> new BerryItem(BerryType.SPELON, GenerationsBlocks.SPELON_BERRY_BUSH, properties), GenerationsCreativeTabs.HELD_ITEMS);
    ...
    public static final RegistrySupplier<Item> LIECHI_BERRY = register("liechi_berry", properties -> new BerryItem(BerryType.LIECHI, GenerationsBlocks.LIECHI_BERRY_BUSH, properties), GenerationsCreativeTabs.HELD_ITEMS);
    ...
    public static final RegistrySupplier<Item> SALAC_BERRY = register("salac_berry", properties -> new BerryItem(BerryType.SALAC, GenerationsBlocks.SALAC_BERRY_BUSH, properties), GenerationsCreativeTabs.HELD_ITEMS);
    ...
    public static final RegistrySupplier<Item> TOUGA_BERRY = register("touga_berry", properties -> new BerryItem(BerryType.TOUGA, GenerationsBlocks.TOUGA_BERRY_BUSH, properties), GenerationsCreativeTabs.HELD_ITEMS);
    ...
    */
    ...
    public static final RegistrySupplier<Item> AZALEA_TOWN_DISC = createMusicDisc("azalea_town_disc", GenerationsSounds.AZALEA_TOWN);
    public static final RegistrySupplier<Item> CASCARRAFA_CITY_DISC = createMusicDisc("cascarrafa_city_disc", GenerationsSounds.CASCARRAFA_CITY);
    public static final RegistrySupplier<Item> CERULEAN_CITY_DISC = createMusicDisc("cerulean_city_disc", GenerationsSounds.CERULEAN_CITY);
    public static final RegistrySupplier<Item> ETERNA_CITY_DISC = createMusicDisc("eterna_city_disc", GenerationsSounds.ETERNA_CITY);
    public static final RegistrySupplier<Item> GOLDENROD_CITY_DISC = createMusicDisc("goldenrod_city_disc", GenerationsSounds.GOLDENROD_CITY);
    public static final RegistrySupplier<Item> ICIRRUS_CITY_DISC = createMusicDisc("icirrus_city_disc", GenerationsSounds.ICIRRUS_CITY);
    public static final RegistrySupplier<Item> JUBILIFE_VILLAGE_DISC = createMusicDisc("jubilife_village_disc", GenerationsSounds.JUBILIFE_VILLAGE);
    public static final RegistrySupplier<Item> LAKE_OF_RAGE_DISC = createMusicDisc("lake_of_rage_disc", GenerationsSounds.LAKE_OF_RAGE);
    public static final RegistrySupplier<Item> LAVERRE_CITY_DISC = createMusicDisc("laverre_city_disc", GenerationsSounds.LAVERRE_CITY);
    public static final RegistrySupplier<Item> LILLIE_DISC = createMusicDisc("lillie_disc", GenerationsSounds.LILLIE);
    public static final RegistrySupplier<Item> POKEMON_CENTER_DISC = createMusicDisc("pokemon_center_disc", GenerationsSounds.POKEMON_CENTER);
    public static final RegistrySupplier<Item> ROUTE_228_DISC = createMusicDisc("route_228_disc", GenerationsSounds.ROUTE_228);
    public static final RegistrySupplier<Item> SLUMBERING_WEALD_DISC = createMusicDisc("slumbering_weald_disc", GenerationsSounds.SLUMBERING_WEALD);
    public static final RegistrySupplier<Item> SURF_DISC = createMusicDisc("surf_disc", GenerationsSounds.SURF);
    public static final RegistrySupplier<Item> VERMILION_CITY_DISC = createMusicDisc("vermilion_city_disc", GenerationsSounds.VERMILION_CITY);
    public static final RegistrySupplier<Item> CYNTHIA_DISC = createMusicDisc("cynthia_disc", GenerationsSounds.CYNTHIA);
    public static final RegistrySupplier<Item> DEOXYS_DISC = createMusicDisc("deoxys_disc", GenerationsSounds.DEOXYS);
    public static final RegistrySupplier<Item> IRIS_DISC = createMusicDisc("iris_disc", GenerationsSounds.IRIS);
    public static final RegistrySupplier<Item> KANTO_DISC = createMusicDisc("kanto_disc", GenerationsSounds.KANTO);
    public static final RegistrySupplier<Item> LUSAMINE_DISC = createMusicDisc("lusamine_disc", GenerationsSounds.LUSAMINE);
    public static final RegistrySupplier<Item> NEMONA_DISC = createMusicDisc("nemona_disc", GenerationsSounds.NEMONA);
    public static final RegistrySupplier<Item> NESSA_DISC = createMusicDisc("nessa_disc", GenerationsSounds.NESSA);
    public static final RegistrySupplier<Item> PENNY_DISC = createMusicDisc("penny_disc", GenerationsSounds.PENNY);
    public static final RegistrySupplier<Item> RIVAL_DISC = createMusicDisc("rival_disc", GenerationsSounds.RIVAL);
    public static final RegistrySupplier<Item> SADA_AND_TURO_DISC = createMusicDisc("sada_and_turo_disc", GenerationsSounds.SADA_AND_TURO);
    public static final RegistrySupplier<Item> SOUTH_PROVINCE_DISC = createMusicDisc("south_province_disc", GenerationsSounds.SOUTH_PROVINCE);
    public static final RegistrySupplier<Item> TEAM_ROCKET_DISC = createMusicDisc("team_rocket_disc", GenerationsSounds.TEAM_ROCKET);
    public static final RegistrySupplier<Item> ULTRA_NECROZMA_DISC = createMusicDisc("ultra_necrozma_disc", GenerationsSounds.ULTRA_NECROZMA);
    public static final RegistrySupplier<Item> XY_LEGENDARY_DISC = createMusicDisc("xy_legendary_disc", GenerationsSounds.XY_LEGENDARY);
    public static final RegistrySupplier<Item> ZINNIA_DISC = createMusicDisc("zinnia_disc", GenerationsSounds.ZINNIA);
    public static final RegistrySupplier<Item> LAVENDER_TOWN_DISC = createMusicDisc("lavender_town_disc", GenerationsSounds.LAVENDER_TOWN);
    public static final RegistrySupplier<Item> LUGIA_DISC = createMusicDisc("lugia_disc", GenerationsSounds.LUGIA);
    public static final RegistrySupplier<Item> MT_PYRE_DISC = createMusicDisc("mt_pyre_disc", GenerationsSounds.MT_PYRE);
