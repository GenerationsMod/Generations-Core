...
public class GenerationsCreativeTabs {
    ...
    public static Supplier<CreativeModeTab> NATURAL;
    ...
    public static void init() {
        ...
        GenerationsCreativeTabs.BUILDING_BLOCKS = create("building_blocks", () -> GenerationsBlocks.LIGHT_BLUE_POKE_BRICK_SET.getBaseBlockSupplier().get().asItem().getDefaultInstance(), GenerationsWood.WOOD_BLOCKS, GenerationsBlocks.BLOCK_ITEMS);
