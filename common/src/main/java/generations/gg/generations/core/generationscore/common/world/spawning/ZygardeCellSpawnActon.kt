...
class ZygardeCellSpawnActon(spawnablePosition: SpawnablePosition, bucket: String, override val detail: ZygardeCellDetail) : SingleEntitySpawnAction<ZygardeCellEntity>(spawnablePosition, bucket, detail) {
