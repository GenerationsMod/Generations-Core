...
object GenerationsConfiguredFeatures {
    ...
    fun bootStrap(context: BootstrapContext<ConfiguredFeature<*, *>>) {
        ...
        register(context, POKE_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.POKE_BALL_LOOT)))
        register(context, BEAST_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.BEAST_BALL_LOOT)))
        register(context, CHERISH_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.CHERISH_BALL_LOOT)))
        register(context, DIVE_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.DIVE_BALL_LOOT)))
        register(context, DREAM_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.DREAM_BALL_LOOT)))
        register(context, DUSK_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.DUSK_BALL_LOOT)))
        register(context, FAST_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.FAST_BALL_LOOT)))
        register(context, FRIEND_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.FRIEND_BALL_LOOT)))
        register(context, GIGATON_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.GIGATON_BALL_LOOT)))
        register(context, GREAT_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.GREAT_BALL_LOOT)))
        register(context, HEAL_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.HEAL_BALL_LOOT)))
        register(context, HEAVY_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.HEAVY_BALL_LOOT)))
        register(context, JET_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.JET_BALL_LOOT)))
        register(context, LEADEN_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.LEADEN_BALL_LOOT)))
        register(context, LEVEL_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.LEVEL_BALL_LOOT)))
        register(context, LOVE_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.LOVE_BALL_LOOT)))
        register(context, LURE_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.LURE_BALL_LOOT)))
        register(context, LUXURY_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.LUXURY_BALL_LOOT)))
        register(context, MASTER_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.MASTER_BALL_LOOT)))
        register(context, MOON_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.MOON_BALL_LOOT)))
        register(context, NEST_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.NEST_BALL_LOOT)))
        register(context, NET_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.NET_BALL_LOOT)))
        register(context, ORIGIN_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.ORIGIN_BALL_LOOT)))
        register(context, PARK_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.PARK_BALL_LOOT)))
        register(context, PREMIER_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.PREMIER_BALL_LOOT)))
        register(context, QUICK_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.QUICK_BALL_LOOT)))
        register(context, REPEAT_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.REPEAT_BALL_LOOT)))
        register(context, SAFARI_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.SAFARI_BALL_LOOT)))
        register(context, SPORT_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.SPORT_BALL_LOOT)))
        register(context, STRANGE_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.STRANGE_BALL_LOOT)))
        register(context, TIMER_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.TIMER_BALL_LOOT)))
        register(context, ULTRA_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.ULTRA_BALL_LOOT)))
        register(context, WING_BALL_LOOT, Feature.SIMPLE_BLOCK, SimpleBlockConfiguration(BlockStateProvider.simple(GenerationsUtilityBlocks.WING_BALL_LOOT)))
    }
