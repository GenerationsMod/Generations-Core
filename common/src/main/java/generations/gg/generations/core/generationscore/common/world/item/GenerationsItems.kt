...
object GenerationsItems {
    ...
    @JvmField val OLD_ROD = register("old_rod", { TieredFishingRodItem(it.durability(64), TieredFishingHookEntity.Teir.OLD) }, PLAYER_ITEMS)
    @JvmField val GOOD_ROD = register("good_rod", { TieredFishingRodItem(it.durability(76), TieredFishingHookEntity.Teir.GOOD) }, PLAYER_ITEMS)
    @JvmField val SUPER_ROD = register("super_rod", { TieredFishingRodItem(it.durability(84), TieredFishingHookEntity.Teir.SUPER) }, PLAYER_ITEMS)
