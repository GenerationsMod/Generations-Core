...
class GenerationsItems {
    companion object {
        ...
        //    @JvmField val METRONOME = registerHeldItem("metronome") TODO: Add world converter entry to convert to cobblemon counterpart
        @JvmField val POKE_DOLL = registerHeldItem("poke_doll")
        @JvmField val POKE_TOY = registerHeldItem("poke_toy")

        //    @JvmField val PROTECTIVE_PADS = registerHeldItem("protective_pads") TODO: Add world converter entry to convert to cobblemon counterpart
//    @JvmField val ROOM_SERVICE = registerHeldItem("room_service") TODO: Add world converter entry to convert to cobblemon counterpart
//    @JvmField val SCOPE_LENS = registerHeldItem("scope_lens") TODO: Add world converter entry to convert to cobblemon counterpart
//    @JvmField val SHED_SHELL = registerHeldItem("shed_shell") TODO: Add world converter entry to convert to cobblemon counterpart
        @JvmField val SNOWBALL = registerHeldItem("snowball")
        @JvmField val SOUL_DEW = registerHeldItem("soul_dew")

        //    @JvmField val TERRAIN_EXTENDER = registerHeldItem("terrain_extender") TODO: Add world converter entry to convert to cobblemon counterpart
        @JvmField val THICK_CLUB = registerHeldItem("thick_club")

        //    @JvmField val THROAT_SPRAY = registerHeldItem("throat_spray") TODO: Add world converter entry to convert to cobblemon counterpart
        @JvmField val UP_GRADE = registerHeldItem("up_grade")

        //    @JvmField val UTILITY_UMBRELLA = registerHeldItem("utility_umbrella") TODO: Add world converter entry to convert to cobblemon counterpart
        @JvmField val WHITE_FLUTE = registerHeldItem("white_flute")

        //    @JvmField val WIDE_LENS = registerHeldItem("wide_lens") TODO: Add world converter entry to convert to cobblemon counterpart
        //    @JvmField val ZOOM_LENS = registerHeldItem("zoom_lens") TODO: Add world converter entry to convert to cobblemon counterpart
        ...
        //    @JvmField val ELECTRIC_SEED = registerHeldItem("electric_seed") TODO: Add world converter entry to convert to cobblemon counterpart
//    @JvmField val MISTY_SEED = registerHeldItem("misty_seed") TODO: Add world converter entry to convert to cobblemon counterpart
//    @JvmField val GRASSY_SEED = registerHeldItem("grassy_seed") TODO: Add world converter entry to convert to cobblemon counterpart
//    @JvmField val PSYCHIC_SEED = registerHeldItem("psychic_seed") TODO: Add world converter entry to convert to cobblemon counterpart
        @JvmField
...
//    }
        ...
        @JvmField val RED_ORB = registerHeldItem("red_orb", ::Item)
        @JvmField val BLUE_ORB = registerHeldItem("blue_orb", ::Item)
        ...
        private fun registerHeldItem(
            name: String,
            function: Function<Item.Properties, Item> = Function { properties ->
                Item(properties)
            }
        ): RegistrySupplier<Item> = register(
            name,
            { function.apply(it).also { CobblemonHeldItemManager.registerRemap(it, name.replace("_", "")) } },
            HELD_ITEMS
        )
        ...
        fun registerTmRegular(name: String, move: String): RegistrySupplier<TechnicalMachineItem> =
            registerTm(name, { TechnicalMachineItem(move, it) }, PLAYER_ITEMS).also(TMS::add)

        private fun registerSign(name: String, itemSupplier: Function<Item.Properties, Item>): RegistrySupplier<Item> =
        ...
        private fun createMusicDisc(name: String, jukeboxSong: ResourceKey<JukeboxSong>): RegistrySupplier<Item> =
            register(
                name,
