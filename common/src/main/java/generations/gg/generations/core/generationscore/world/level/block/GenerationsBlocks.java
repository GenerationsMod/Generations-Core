...
public class GenerationsBlocks {
    ...
    public static final RegistrySupplier<Block> TREE_TOP = registerBlockItem("tree_top", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistrySupplier<Block> TREE_BOTTOM = registerBlockItem("tree_bottom", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistrySupplier<Block> WOODEN_FLOORING = registerBlockItem("wooden_flooring", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
