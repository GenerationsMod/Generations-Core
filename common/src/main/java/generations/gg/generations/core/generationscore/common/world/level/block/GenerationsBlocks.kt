...
@Suppress("unused")
object GenerationsBlocks: BlockPlatformRegistry() {
    ...
    val CHARGE_STONE_BRICK_STAIRS = registerStone("charge_stone_brick_stairs", { StairBlock(Blocks.STONE_BRICK_STAIRS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(CHARGE_STONE_BRICKS.value())) })
    val CHARGE_STONE_BRICK_SLAB = registerStone("charge_stone_brick_slab", { SlabBlock(BlockBehaviour.Properties.ofFullCopy(CHARGE_STONE_BRICKS.value())) })
    val CHARGE_STONE_BRICK_WALL = registerStone("charge_stone_brick_wall", { WallBlock(BlockBehaviour.Properties.ofFullCopy(CHARGE_STONE_BRICKS.value())) })
    ...
    val INFESTED_CHARGE_STONE_BRICKS = registerStone("infested_charge_stone_bricks", { InfestedBlock(CHARGE_STONE_BRICKS.value(), BlockBehaviour.Properties.ofFullCopy(Blocks.INFESTED_STONE_BRICKS)) })
    ...
    val INFESTED_CRACKED_CHARGE_STONE_BRICKS = registerStone("infested_cracked_charge_stone_bricks", { InfestedBlock(CRACKED_CHARGE_STONE_BRICKS.value(), BlockBehaviour.Properties.ofFullCopy(Blocks.INFESTED_CRACKED_STONE_BRICKS)) })
    val INFESTED_CHISELED_CHARGE_STONE_BRICKS = registerStone("infested_chiseled_charge_stone_bricks", { InfestedBlock(CHISELED_CHARGE_STONE_BRICKS.value(), BlockBehaviour.Properties.ofFullCopy(Blocks.INFESTED_CHISELED_STONE_BRICKS)) })
    ...
    val POINTED_CHARGE_DRIPSTONE = registerStone("pointed_charge_dripstone", {PointedChargeDripstoneBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.POINTED_DRIPSTONE)) })
    ...
    val VOLCANIC_STONE_STAIRS = registerStone("volcanic_stone_stairs", { StairBlock(Blocks.STONE_STAIRS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(VOLCANIC_STONE.value())) })
    val VOLCANIC_STONE_SLAB = registerStone("volcanic_stone_slab", { SlabBlock(BlockBehaviour.Properties.ofFullCopy(VOLCANIC_STONE.value())) })
    val VOLCANIC_STONE_WALL = registerStone("volcanic_stone_wall", { WallBlock(BlockBehaviour.Properties.ofFullCopy(VOLCANIC_STONE.value())) })
    val VOLCANIC_STONE_BUTTON = registerStone("volcanic_stone_button", { ButtonBlock(GenerationsBlockSetTypes.VOLCANIC_STONE, 20, BlockBehaviour.Properties.ofFullCopy(VOLCANIC_STONE.value())) })
    val VOLCANIC_STONE_PRESSURE_PLATE = registerStone("volcanic_stone_pressure_plate", { PressurePlateBlock(GenerationsBlockSetTypes.VOLCANIC_STONE, BlockBehaviour.Properties.ofFullCopy(VOLCANIC_STONE.value())) })
    ...
    val SMOOTH_VOLCANIC_STONE_SLAB = registerStone("smooth_volcanic_stone_slab", { SlabBlock(BlockBehaviour.Properties.ofFullCopy(SMOOTH_VOLCANIC_STONE.value())) })
    ...
    val VOLCANIC_STONE_BRICK_STAIRS = registerStone("volcanic_stone_brick_stairs") { StairBlock(Blocks.STONE_BRICK_STAIRS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(VOLCANIC_STONE_BRICKS.value())) }
    val VOLCANIC_STONE_BRICK_SLAB = registerStone("volcanic_stone_brick_slab") { SlabBlock(BlockBehaviour.Properties.ofFullCopy(VOLCANIC_STONE_BRICKS.value())) }
    val VOLCANIC_STONE_BRICK_WALL = registerStone("volcanic_stone_brick_wall") { WallBlock(BlockBehaviour.Properties.ofFullCopy(VOLCANIC_STONE_BRICKS.value())) }
    ...
    val INFESTED_VOLCANIC_STONE = registerStone("infested_volcanic_stone", { InfestedBlock(VOLCANIC_STONE.value(), BlockBehaviour.Properties.ofFullCopy(Blocks.INFESTED_STONE)) })
    ...
    val INFESTED_VOLCANIC_STONE_BRICKS = registerStone("infested_volcanic_stone_bricks", { InfestedBlock(VOLCANIC_STONE_BRICKS.value(), BlockBehaviour.Properties.ofFullCopy(Blocks.INFESTED_STONE_BRICKS)) })
    ...
    val INFESTED_CRACKED_VOLCANIC_STONE_BRICKS = registerStone("infested_cracked_volcanic_stone_bricks", { InfestedBlock(CRACKED_VOLCANIC_STONE_BRICKS.value(), BlockBehaviour.Properties.ofFullCopy(Blocks.INFESTED_STONE_BRICKS)) })
    val INFESTED_CHISELED_VOLCANIC_STONE_BRICKS = registerStone("infested_chiseled_volcanic_stone_bricks", { InfestedBlock(CHISELED_VOLCANIC_STONE_BRICKS.value(), BlockBehaviour.Properties.ofFullCopy(Blocks.INFESTED_STONE_BRICKS)) })
    ...
    val SUBWAY_WALL_SLAB = registerBlockItem("subway_wall_slab", { SlabBlock(BlockBehaviour.Properties.ofFullCopy(SUBWAY_WALL.value())) })
    val SUBWAY_WALL_2_SLAB = registerBlockItem("subway_wall_2_slab", { SlabBlock(BlockBehaviour.Properties.ofFullCopy(SUBWAY_WALL_2.value())) })
    val SUBWAY_WALL_STAIRS = registerBlockItem("subway_wall_stairs", { StairBlock(SUBWAY_WALL.value().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SUBWAY_WALL.value())) })
    val SUBWAY_WALL_2_STAIRS = registerBlockItem("subway_wall_2_stairs", { StairBlock(SUBWAY_WALL_2.value().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SUBWAY_WALL_2.value())) })
    ...
    val GOLDEN_TEMPLE_SMOOTH_SANDSTONE_STAIRS = registerBlockItem("golden_temple_smooth_sandstone_stairs", { StairBlock(GOLDEN_TEMPLE_SMOOTH_SANDSTONE.value().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(GOLDEN_TEMPLE_SMOOTH_SANDSTONE.value())) })
    val GOLDEN_TEMPLE_SMOOTH_SANDSTONE_SLAB = registerBlockItem("golden_temple_smooth_sandstone_slab", { SlabBlock(BlockBehaviour.Properties.ofFullCopy(GOLDEN_TEMPLE_SMOOTH_SANDSTONE.value())) })
    val GOLDEN_TEMPLE_SMOOTH_SANDSTONE_WALL = registerBlockItem("golden_temple_smooth_sandstone_wall", { WallBlock(BlockBehaviour.Properties.ofFullCopy(GOLDEN_TEMPLE_SMOOTH_SANDSTONE.value())) })
    ...
    val SAPPHIRE_STAIRS = registerBlockItem("sapphire_stairs", { StairBlock(Blocks.STONE_STAIRS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(SAPPHIRE_BLOCK.value())) })
    val SAPPHIRE_SLAB = registerBlockItem("sapphire_slab", { SlabBlock(BlockBehaviour.Properties.ofFullCopy(SAPPHIRE_BLOCK.value())) })
    val SAPPHIRE_WALL = registerBlockItem("sapphire_wall", { WallBlock(BlockBehaviour.Properties.ofFullCopy(SAPPHIRE_BLOCK.value())) })


    val RUBY_BLOCK = registerBlockItem("ruby_block", { Block(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK)) })
    val RUBY_STAIRS = registerBlockItem("ruby_stairs", { StairBlock(Blocks.STONE_STAIRS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(RUBY_BLOCK.value())) })
    val RUBY_SLAB = registerBlockItem("ruby_slab", { SlabBlock(BlockBehaviour.Properties.ofFullCopy(RUBY_BLOCK.value())) })
    val RUBY_WALL = registerBlockItem("ruby_wall", { WallBlock(BlockBehaviour.Properties.ofFullCopy(RUBY_BLOCK.value())) })

    val CRYSTAL_BLOCK = registerBlockItem("crystal_block", { Block(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK)) })
    val CRYSTAL_STAIRS = registerBlockItem("crystal_stairs", { StairBlock(Blocks.STONE_STAIRS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(CRYSTAL_BLOCK.value())) })
    val CRYSTAL_SLAB = registerBlockItem("crystal_slab", { SlabBlock(BlockBehaviour.Properties.ofFullCopy(CRYSTAL_BLOCK.value())) })
    val CRYSTAL_WALL = registerBlockItem("crystal_wall", { WallBlock(BlockBehaviour.Properties.ofFullCopy(CRYSTAL_BLOCK.value())) })
    val CRYSTAL_LIGHT = registerBlockItem("crystal_light", { Block(BlockBehaviour.Properties.ofFullCopy(CRYSTAL_BLOCK.value()).lightLevel { 15 }) })
    ...
    val ULTRA_SANDSTONE_STAIRS = registerBlockItem("ultra_sandstone_stairs", { StairBlock(Blocks.STONE_STAIRS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(ULTRA_SANDSTONE.value())) })
    val ULTRA_SANDSTONE_SLAB = registerBlockItem("ultra_sandstone_slab", { SlabBlock(BlockBehaviour.Properties.ofFullCopy(ULTRA_SANDSTONE.value())) })
    val ULTRA_SANDSTONE_WALL = registerBlockItem("ultra_sandstone_wall", { WallBlock(BlockBehaviour.Properties.ofFullCopy(ULTRA_SANDSTONE.value())) })
    ...
    val ULTRA_SMOOTH_SANDSTONE_STAIRS = registerBlockItem("ultra_smooth_sandstone_stairs", { StairBlock(Blocks.STONE_STAIRS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(ULTRA_SMOOTH_SANDSTONE.value())) })
    val ULTRA_SMOOTH_SANDSTONE_SLAB = registerBlockItem("ultra_smooth_sandstone_slab", { SlabBlock(BlockBehaviour.Properties.ofFullCopy(ULTRA_SMOOTH_SANDSTONE.value())) })
    val ULTRA_SMOOTH_SANDSTONE_WALL = registerBlockItem("ultra_smooth_sandstone_wall", { WallBlock(BlockBehaviour.Properties.ofFullCopy(ULTRA_SMOOTH_SANDSTONE.value())) })
    ...
    val ULTRA_CUT_SANDSTONE_SLAB = registerBlockItem("ultra_cut_sandstone_slab", { SlabBlock(BlockBehaviour.Properties.ofFullCopy(ULTRA_CUT_SANDSTONE.value())) })
    ...
    ) = register.create(name) { itemSupplier.invoke(Item.Properties()) }

    private fun registerUnownBlock(name: String, glyph: String? = null): Holder<Block> = registerBlockItem("unown_block_$name", { UnownBlock(glyph ?: name.uppercase(), STONE_PROPERTY) })
