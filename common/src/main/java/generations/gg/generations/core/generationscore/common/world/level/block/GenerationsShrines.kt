...
object GenerationsShrines: BlockPlatformRegistry() {
    ...
    private fun <T : Block> registerBlockItem(name: String, blockSupplier: () -> T): Holder<Block> = registerBlockItem(name, blockSupplier, ::BlockItemWithLang)


    private fun <T : Block> registerBlockItem(name: String, blockSupplier: () -> T, function: (Holder<Block>, Item.Properties) -> Item): Holder<Block> = registerBlockItem(name, blockSupplier, function, GenerationsItems.ITEMS)
