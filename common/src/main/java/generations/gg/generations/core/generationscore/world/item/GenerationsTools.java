...
public class GenerationsTools {
	...
	public static final RegistrySupplier<Item> ALUMINUM_SHOVEL = register("aluminum_shovel", properties -> new GenerationsShovelItem(GenerationsTiers.ALUMINUM, -3.0F, properties), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> ALUMINUM_PICKAXE = register("aluminum_pickaxe", properties -> new GenerationsPickaxeItem(GenerationsTiers.ALUMINUM, -2.8F, properties), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> ALUMINUM_AXE = register("aluminum_axe", properties -> new GenerationsAxeItem(GenerationsTiers.ALUMINUM, -3.1F, properties), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> ALUMINUM_HOE = register("aluminum_hoe", properties -> new GenerationsHoeItem(GenerationsTiers.ALUMINUM, -1.0F, properties), CreativeModeTabs.TOOLS_AND_UTILITIES);
	...
	public static final RegistrySupplier<Item> DAWN_STONE_AXE = register("dawn_stone_axe", properties -> new GenerationsAxeItem(GenerationsTiers.DAWN_STONE, -3.0F, properties).addToolEffect(new PotionToolEffect(MobEffects.HEALTH_BOOST, 0, 6000, 1)), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> DAWN_STONE_HOE = register("dawn_stone_hoe", properties -> new GenerationsHoeItem(GenerationsTiers.DAWN_STONE, -3.0F, properties).addToolEffect(new PotionToolEffect(MobEffects.HEALTH_BOOST, 0, 6000, 1)), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> DAWN_STONE_HAMMER = register("dawn_stone_hammer", properties -> new GenerationsHammerItem(GenerationsTiers.DAWN_STONE, 6.0F, -3.0F, properties).addToolEffect(new PotionToolEffect(MobEffects.HEALTH_BOOST, 0, 6000, 1)), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> DAWN_STONE_SWORD = register("dawn_stone_sword", properties -> new GenerationsSwordItem(GenerationsTiers.DAWN_STONE, -2.4F, properties).addToolEffect(new PotionToolEffect(MobEffects.HEALTH_BOOST, 0, 6000, 1)), CreativeModeTabs.COMBAT);

	public static final RegistrySupplier<Item> DUSK_STONE_SHOVEL = register("dusk_stone_shovel", properties -> new GenerationsShovelItem(GenerationsTiers.DUSK_STONE, -3.0F, properties).addToolEffect(new PotionToolEffect(MobEffects.INVISIBILITY, 0, 6000, 1)), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> DUSK_STONE_PICKAXE = register("dusk_stone_pickaxe", properties -> new GenerationsPickaxeItem(GenerationsTiers.DUSK_STONE, -2.8F, properties).addToolEffect(new PotionToolEffect(MobEffects.INVISIBILITY, 0, 6000, 1)), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> DUSK_STONE_AXE = register("dusk_stone_axe", properties -> new GenerationsAxeItem(GenerationsTiers.DUSK_STONE, -3.0F, properties).addToolEffect(new PotionToolEffect(MobEffects.INVISIBILITY, 0, 6000, 1)), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> DUSK_STONE_HOE = register("dusk_stone_hoe", properties -> new GenerationsHoeItem(GenerationsTiers.DUSK_STONE, -3.0F, properties).addToolEffect(new PotionToolEffect(MobEffects.INVISIBILITY, 0, 6000, 1)), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> DUSK_STONE_HAMMER = register("dusk_stone_hammer", properties -> new GenerationsHammerItem(GenerationsTiers.DUSK_STONE, 6.0F, -3.0F, properties).addToolEffect(new PotionToolEffect(MobEffects.INVISIBILITY, 0, 6000, 1)), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> DUSK_STONE_SWORD = register("dusk_stone_sword", properties -> new GenerationsSwordItem(GenerationsTiers.DUSK_STONE, -2.4F, properties).addToolEffect(new PotionToolEffect(MobEffects.INVISIBILITY, 0, 6000, 1)), CreativeModeTabs.COMBAT);

	public static final RegistrySupplier<Item> FIRE_STONE_SHOVEL = register("fire_stone_shovel", properties -> new GenerationsShovelItem(GenerationsTiers.FIRE_STONE, -3.0F, properties).addToolEffect(new TransformToolEffect(Blocks.WATER, Blocks.OBSIDIAN, 1)), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> FIRE_STONE_PICKAXE = register("fire_stone_pickaxe", properties -> new GenerationsPickaxeItem(GenerationsTiers.FIRE_STONE, -2.8F, properties).addToolEffect(new TransformToolEffect(Blocks.WATER, Blocks.OBSIDIAN, 1)), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> FIRE_STONE_AXE = register("fire_stone_axe", properties -> new GenerationsAxeItem(GenerationsTiers.FIRE_STONE, -3.0F, properties).addToolEffect(new TransformToolEffect(Blocks.WATER, Blocks.OBSIDIAN, 1)), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> FIRE_STONE_HOE = register("fire_stone_hoe", properties -> new GenerationsHoeItem(GenerationsTiers.FIRE_STONE, 0.0F, properties).addToolEffect(new TransformToolEffect(Blocks.WATER, Blocks.OBSIDIAN, 1)), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> FIRE_STONE_HAMMER = register("fire_stone_hammer", properties -> new GenerationsHammerItem(GenerationsTiers.FIRE_STONE, 5.0F, -3.0F, properties).addToolEffect(new TransformToolEffect(Blocks.WATER, Blocks.OBSIDIAN, 1)), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> FIRE_STONE_SWORD = register("fire_stone_sword", properties -> new GenerationsSwordItem(GenerationsTiers.FIRE_STONE, -2.4F, properties).addToolEffect(new TransformToolEffect(Blocks.WATER, Blocks.OBSIDIAN, 1)), CreativeModeTabs.COMBAT);

	public static final RegistrySupplier<Item> ICE_STONE_SHOVEL = register("ice_stone_shovel", properties -> new GenerationsShovelItem(GenerationsTiers.ICE_STONE, -3.0F, properties).addToolEffect(new TransformToolEffect(Blocks.WATER, Blocks.ICE, 1)).addToolEffect(new TransformToolEffect(Blocks.ICE, Blocks.PACKED_ICE, 3)).addToolEffect(new TransformToolEffect(Blocks.PACKED_ICE, Blocks.BLUE_ICE, 9)), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> ICE_STONE_PICKAXE = register("ice_stone_pickaxe", properties -> new GenerationsPickaxeItem(GenerationsTiers.ICE_STONE, -2.8F, properties).addToolEffect(new TransformToolEffect(Blocks.WATER, Blocks.ICE, 1)).addToolEffect(new TransformToolEffect(Blocks.ICE, Blocks.PACKED_ICE, 3)).addToolEffect(new TransformToolEffect(Blocks.PACKED_ICE, Blocks.BLUE_ICE, 9)), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> ICE_STONE_AXE = register("ice_stone_axe", properties -> new GenerationsAxeItem(GenerationsTiers.ICE_STONE, -3.0F, properties).addToolEffect(new TransformToolEffect(Blocks.WATER, Blocks.ICE, 1)).addToolEffect(new TransformToolEffect(Blocks.ICE, Blocks.PACKED_ICE, 3)).addToolEffect(new TransformToolEffect(Blocks.PACKED_ICE, Blocks.BLUE_ICE, 9)), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> ICE_STONE_HOE = register("ice_stone_hoe", properties -> new GenerationsHoeItem(GenerationsTiers.ICE_STONE, -3.0F, properties).addToolEffect(new TransformToolEffect(Blocks.WATER, Blocks.ICE, 1)).addToolEffect(new TransformToolEffect(Blocks.ICE, Blocks.PACKED_ICE, 3)).addToolEffect(new TransformToolEffect(Blocks.PACKED_ICE, Blocks.BLUE_ICE, 9)), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> ICE_STONE_HAMMER = register("ice_stone_hammer", properties -> new GenerationsHammerItem(GenerationsTiers.ICE_STONE, 6.0F, -3.0F, properties).addToolEffect(new TransformToolEffect(Blocks.WATER, Blocks.ICE, 1)).addToolEffect(new TransformToolEffect(Blocks.ICE, Blocks.PACKED_ICE, 3)).addToolEffect(new TransformToolEffect(Blocks.PACKED_ICE, Blocks.BLUE_ICE, 9)), CreativeModeTabs.TOOLS_AND_UTILITIES);
	public static final RegistrySupplier<Item> ICE_STONE_SWORD = register("ice_stone_sword", properties -> new GenerationsSwordItem(GenerationsTiers.ICE_STONE, -2.4F, properties).addToolEffect(new TransformToolEffect(Blocks.WATER, Blocks.ICE, 1)).addToolEffect(new TransformToolEffect(Blocks.ICE, Blocks.PACKED_ICE, 3)).addToolEffect(new TransformToolEffect(Blocks.PACKED_ICE, Blocks.BLUE_ICE, 9)), CreativeModeTabs.COMBAT);
