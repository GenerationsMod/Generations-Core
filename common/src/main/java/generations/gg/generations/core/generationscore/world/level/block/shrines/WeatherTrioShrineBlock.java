...
import com.pokemod.pokemod.world.level.block.entities.WeatherTrioShrineBlockEntity;
...
public class WeatherTrioShrineBlock extends InteractShrineBlock<WeatherTrioShrineBlockEntity> {
    ...
    private final RegistryObject<Item> requiredItem;

    public WeatherTrioShrineBlock(BlockBehaviour.Properties properties, ResourceLocation model, ResourceLocation species, RegistryObject<Item> requiredItem) {
