...
public class PokeModWood {
    ...
    public static final RegistrySupplier<ButtonBlock> ULTRA_JUNGLE_BUTTON = registerBlockItem("ultra_jungle_button", () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.JUNGLE_BUTTON), BlockSetType.JUNGLE, 30, true));
    public static final RegistrySupplier<PressurePlateBlock>  ULTRA_JUNGLE_PRESSURE_PLATE = registerBlockItem("ultra_jungle_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(Blocks.JUNGLE_PRESSURE_PLATE), BlockSetType.JUNGLE));
    public static final RegistrySupplier<PokeModCraftingTableBlock> ULTRA_JUNGLE_CRAFTING_TABLE = registerBlockItem("ultra_jungle_crafting_table", () -> new PokeModCraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistrySupplier<TrapDoorBlock> ULTRA_JUNGLE_TRAPDOOR = registerBlockItem("ultra_jungle_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.JUNGLE_TRAPDOOR), BlockSetType.JUNGLE));
    public static final RegistrySupplier<DoorBlock> ULTRA_JUNGLE_DOOR = registerBlockItem("ultra_jungle_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.JUNGLE_DOOR), BlockSetType.JUNGLE));
    ...
    public static final RegistrySupplier<StandingSignBlock> ULTRA_JUNGLE_SIGN = registerBlockWithoutItem("ultra_jungle_sign", () -> new PokeModStandingSignBlock(BlockBehaviour.Properties.copy(Blocks.JUNGLE_SIGN), PokeModWoodTypes.ULTRA_JUNGLE));
    public static final RegistrySupplier<WallSignBlock> ULTRA_JUNGLE_WALL_SIGN = registerSignWithoutItem("ultra_jungle_wall_sign", () -> new PokeModWallSignBlock(BlockBehaviour.Properties.copy(Blocks.JUNGLE_WALL_SIGN), PokeModWoodTypes.ULTRA_JUNGLE));
    public static final RegistrySupplier<CeilingHangingSignBlock> ULTRA_JUNGLE_HANGING_SIGN = registerBlockWithoutItem("ultra_jungle_hanging_sign", () -> new PokeModCeilingHangingSignBlock(BlockBehaviour.Properties.copy(Blocks.JUNGLE_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), PokeModWoodTypes.ULTRA_JUNGLE));
    public static final RegistrySupplier<WallHangingSignBlock> ULTRA_JUNGLE_WALL_HANGING_SIGN = registerSignWithoutItem("ultra_jungle_wall_hanging_sign", () -> new PokeModWallHangingSignBlock(BlockBehaviour.Properties.copy(Blocks.JUNGLE_WALL_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), PokeModWoodTypes.ULTRA_JUNGLE));
    ...
    public static final RegistrySupplier<ButtonBlock> ULTRA_DARK_BUTTON = registerBlockItem("ultra_dark_button", () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_BUTTON), BlockSetType.DARK_OAK, 30, true));
    public static final RegistrySupplier<PressurePlateBlock>  ULTRA_DARK_PRESSURE_PLATE = registerBlockItem("ultra_dark_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(Blocks.DARK_OAK_PRESSURE_PLATE), BlockSetType.DARK_OAK));
    public static final RegistrySupplier<PokeModCraftingTableBlock> ULTRA_DARK_CRAFTING_TABLE = registerBlockItem("ultra_dark_crafting_table", () -> new PokeModCraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistrySupplier<TrapDoorBlock> ULTRA_DARK_TRAPDOOR = registerBlockItem("ultra_dark_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_TRAPDOOR), BlockSetType.DARK_OAK));
    public static final RegistrySupplier<DoorBlock> ULTRA_DARK_DOOR = registerBlockItem("ultra_dark_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_DOOR), BlockSetType.DARK_OAK));
    ...
    public static final RegistrySupplier<StandingSignBlock> ULTRA_DARK_SIGN = registerBlockWithoutItem("ultra_dark_sign", () -> new PokeModStandingSignBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_SIGN), PokeModWoodTypes.ULTRA_DARK));
    public static final RegistrySupplier<WallSignBlock> ULTRA_DARK_WALL_SIGN = registerSignWithoutItem("ultra_dark_wall_sign", () -> new PokeModWallSignBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_WALL_SIGN), PokeModWoodTypes.ULTRA_DARK));
    public static final RegistrySupplier<CeilingHangingSignBlock> ULTRA_DARK_HANGING_SIGN = registerBlockWithoutItem("ultra_dark_hanging_sign", () -> new PokeModCeilingHangingSignBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), PokeModWoodTypes.ULTRA_DARK));
    public static final RegistrySupplier<WallHangingSignBlock> ULTRA_DARK_WALL_HANGING_SIGN = registerSignWithoutItem("ultra_dark_wall_hanging_sign", () -> new PokeModWallHangingSignBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_WALL_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), PokeModWoodTypes.ULTRA_DARK));
    ...
    public static final RegistrySupplier<ButtonBlock> GHOST_BUTTON = registerBlockItem("ghost_button", () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_BUTTON), BlockSetType.DARK_OAK, 30, true));
    public static final RegistrySupplier<PressurePlateBlock>  GHOST_PRESSURE_PLATE = registerBlockItem("ghost_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(Blocks.DARK_OAK_PRESSURE_PLATE), BlockSetType.DARK_OAK));
    public static final RegistrySupplier<PokeModCraftingTableBlock> GHOST_CRAFTING_TABLE = registerBlockItem("ghost_crafting_table", () -> new PokeModCraftingTableBlock(BlockBehaviour.Properties.copy(Blocks.CRAFTING_TABLE)));
    public static final RegistrySupplier<TrapDoorBlock> GHOST_TRAPDOOR = registerBlockItem("ghost_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_TRAPDOOR), BlockSetType.DARK_OAK));
    public static final RegistrySupplier<DoorBlock> GHOST_DOOR = registerBlockItem("ghost_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_DOOR), BlockSetType.DARK_OAK));
    ...
    public static final RegistrySupplier<FenceGateBlock> GHOST_FENCE_GATE = registerBlockItem("ghost_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_FENCE_GATE), PokeModWoodTypes.GHOST));
    public static final RegistrySupplier<StandingSignBlock> GHOST_SIGN = registerBlockWithoutItem("ghost_sign", () -> new PokeModStandingSignBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_SIGN), PokeModWoodTypes.GHOST));
    public static final RegistrySupplier<WallSignBlock> GHOST_WALL_SIGN = registerSignWithoutItem("ghost_wall_sign", () -> new PokeModWallSignBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_WALL_SIGN), PokeModWoodTypes.GHOST));
    public static final RegistrySupplier<CeilingHangingSignBlock> GHOST_HANGING_SIGN = registerBlockWithoutItem("ghost_hanging_sign", () -> new PokeModCeilingHangingSignBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), PokeModWoodTypes.GHOST));
