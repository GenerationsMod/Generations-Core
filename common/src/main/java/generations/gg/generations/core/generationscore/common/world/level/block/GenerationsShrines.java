...
public class GenerationsShrines {
	...
	public static final RegistrySupplier<PrisonBottleBlock> PRISON_BOTTLE = registerBlockItem("prison_bottle", () -> new PrisonBottleBlock(BOTTLE_PROPERTIES), BlockItemWithLang::new, GenerationsItems.LEGENDARY_ITEMS);
