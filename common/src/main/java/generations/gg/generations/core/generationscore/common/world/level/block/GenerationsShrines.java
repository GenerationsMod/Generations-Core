...
import generations.gg.generations.core.generationscore.common.world.item.PrisonBottleItem;
...
public class GenerationsShrines {
	...
	public static final RegistrySupplier<PrisonBottleBlock> PRISON_BOTTLE = registerBlockItem("prison_bottle", () -> new PrisonBottleBlock(BOTTLE_PROPERTIES), PrisonBottleItem::new, GenerationsItems.LEGENDARY_ITEMS);
