...
import com.pokemod.pokemod.world.entity.TieredFishingHookEntity;
...
//            }
            ...
            int j = 16;
            for (int k = 0; k <= 16; ++k) {
                net.minecraft.client.renderer.entity.FishingHookRenderer.stringVertex(f4, f5, f6, vertexconsumer1, posestack$pose1, net.minecraft.client.renderer.entity.FishingHookRenderer.fraction(k, 16), net.minecraft.client.renderer.entity.FishingHookRenderer.fraction(k + 1, 16));
            }
            matrixStack.popPose();
