...
import generations.gg.generations.core.generationscore.common.network.packets.statue.*;
...
public class GenerationsNetwork implements GenerationsImplementation.NetworkManager {
    ...
    public void registerClientBound() {
        ...
        this.createClientBound(S2CPlaySoundPacket.ID, S2CPlaySoundPacket.class, S2CPlaySoundPacket::decode, () -> S2CPlaySoundHandler::new);
    }
