...
class TablePc(properties: Properties) : PcBlock<DefaultPcBlockEntity, TablePc>(GenerationsBlockEntities.PC, DefaultPcBlockEntity::class.java, properties, GenerationsBlockEntityModels.TABLE_PC, 0, 0, 0) {
