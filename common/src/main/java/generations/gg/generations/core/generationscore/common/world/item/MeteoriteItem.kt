...
class MeteoriteItem(arg: Properties) : EnchantableItem(arg.component(GenerationsDataComponents.USED.value(), false)), LangTooltip, GenerationsCobblemonInteractions.PokemonInteraction {
