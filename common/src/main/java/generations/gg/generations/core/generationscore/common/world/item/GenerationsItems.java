...
//    public static final RegistrySupplier<Item> PRISON_BOTTLE = register("prison_bottle", Item::new, LEGENDARY_ITEMS);
    ...
    public static final RegistrySupplier<ItemWithLangTooltipImpl> ENIGMA_FRAGMENT = register("enigma_fragment", properties -> new ItemWithLangTooltipImpl(properties.stacksTo(64).fireResistant() /* just incase it falls into lava while in nether*/), LEGENDARY_ITEMS);
