...
object ModelRegistry {
    ...
    private val LOADER = Caffeine.newBuilder().expireAfterAccess(10, TimeUnit.SECONDS).removalListener { _: ResourceLocation?, value: CompiledModel?, _: RemovalCause? -> value!!.delete() }
