...
public class DefaultRksCategory implements DisplayCategory<DefaultRksMachineRecipeDisplay<?>> {
    ...
    public Renderer getIcon() {
        return EntryStacks.of(GenerationsUtilityBlocks.RKS_MACHINE.get());
    }

    @Override
    public List<Widget> setupDisplay(DefaultRksMachineRecipeDisplay<?> display, Rectangle bounds) {
    ...
    public DisplayMerger<DefaultRksMachineRecipeDisplay<?>> getDisplayMerger() {
        return new DisplayMerger<>() {
            @Override
            public boolean canMerge(DefaultRksMachineRecipeDisplay<?> first, DefaultRksMachineRecipeDisplay<?> second) {
            ...
            @Override
            public int hashOf(DefaultRksMachineRecipeDisplay<?> display) {
