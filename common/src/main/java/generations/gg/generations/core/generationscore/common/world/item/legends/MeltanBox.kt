...
class MeltanBoxItem(properties: Properties) : Item(properties), LangTooltip {
    ...
    override fun addText(
        ...
        tooltipComponents.add("item.generations_core.meltan_box.tooltip.lore1".asTranslated())
        tooltipComponents.add("item.generations_core.meltan_box.tooltip.lore2".asTranslated())
        tooltipComponents.add("item.generations_core.meltan_box.tooltip.lore3".asTranslated(stack.damageValue, stack.maxDamage))
    }
